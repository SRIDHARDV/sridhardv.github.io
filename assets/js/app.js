/* ============================================================
   ...
   Home page: renders profile.md in the browser.
   Project pages: generated by tools/build.py into projects/<slug>/;
   this file only hydrates the footer and the table-of-contents spy.
   ============================================================ */
(function () {
  'use strict';
  ...
  /* ── Where the site root is, relative to this page ───────
     projects/<slug>/ pages declare data-root="../../"; top-level pages
  ...
  function projectCard(p) {
    ...
    var media = p.cover
      ...
      : '';
    return '<a class="card reveal" href="' + esc(ROOT + 'projects/' + p.slug + '/') + '">' + media +
      '<div class="card-body">' +
  ...
  /* ── The project manifest ──────────────────────────────
     projects/manifest.json holds everything the grid needs — slug, title,
     ...
     project means adding projects/<slug>/index.md and running the build
     (or pushing and letting the Action do it).                           */
  function loadProjects() {
    var grid = $('#projectGrid');
    if (!grid) return;

    fetchText('projects/manifest.json')
      .then(function (t) {
  ...
  function initHome() {
    ...
    fetchText('profile.md').then(function (raw) {
  ...
  /* ── Project page ────────────────────────────────────────
     Pages under /projects/<slug>/ are generated by tools/build.py and arrive
